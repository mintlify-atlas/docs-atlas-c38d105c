---
title: "Build the AmnesiaOS Initramfs CPIO Archive with BusyBox"
sidebarTitle: "Initramfs"
description: "Run build-initramfs.sh to build the AmnesiaOS initramfs: downloads BusyBox 1.35.0, creates the directory tree, writes the init script, and packs it."
---
